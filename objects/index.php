...
$_SESSION['saveFile'] =  $_SERVER['DOCUMENT_ROOT']."/ratings/data/objects_".$_SESSION['part_id'].'.txt';
		...
		<div class="experiment">
			<?php
				...
				foreach($img_list as $item){
					...
					if ($item == "object_stim-02.png") {
						$word_choices = array("Gun","Drill");
					} elseif ($item == "object_stim-03.png") {
						$word_choices = array("Gun","Fun");
					} elseif ($item == "object_stim-04.png") {
						$word_choices = array("Face","Vase");
					} elseif ($item == "object_stim-05.png") {
						$word_choices = array("Jazz","Face");
					} elseif ($item == "object_stim-06.png") {
						$word_choices = array("Rocket","Squid");
					} elseif ($item == "object_stim-07.png") {
						$word_choices = array("Fish","Rocket");
					} elseif ($item == "object_stim-08.png") {
						$word_choices = array("Duck","Rabbit");
					}
